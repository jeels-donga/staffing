                    ...
                    <div className="w-3/4 p-4">
                        <Card>
                            <CardBody>
                                ...
                                <h2 className="text-xl font-semibold mb-2">Evolving</h2>
                                <p className="text-gray-700">Our process is flexible and constantly adapting to support innovation.</p>
                                <p className="text-gray-700">Continuous management throughout all project stages</p>
                                <p className="text-gray-700">Our Project Management process starts early on and drives the following actions:</p>
                                <p className="text-gray-700">Shaping SOW</p>
                                <p className="text-gray-700">Knowledge Transfer</p>
                                <p className="text-gray-700">Assembling of Engineering, QA and Design Teams</p>
                            </CardBody>
                        </Card>
                    </div>
                </div>
